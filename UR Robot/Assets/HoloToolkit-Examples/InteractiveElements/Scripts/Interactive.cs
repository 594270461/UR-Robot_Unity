...
namespace HoloToolkit.Examples.InteractiveElements
{
    ...
    public class Interactive : MonoBehaviour, IInputClickHandler, IFocusable, IInputHandler
    {
        ...
        public GetRobotLocation getRobotLocation;
        public GetPosterLocation getPosterLocation;
        public GetBallLocation getBallLocation;
        public GetBallandPosterPosDiff diff;
        public KeepTrackRobotMovement track;
        ...
        public virtual void OnInputClicked(InputClickedEventData eventData)
        {
            switch (gameObject.name)
            {
                case "ConnectButton":
                    ...
                    break;
                case "MoveButton":
                    getRobotLocation.GetrobotLocation();
                    getPosterLocation.GetPosLocation();
                    getBallLocation.GetBallPos();
                    diff.GetDifference();
                    send.SendMoveData(SendData.move);
                    track.KeepTrackBallPosition();
                    break;
                case "SendLocationButton":
